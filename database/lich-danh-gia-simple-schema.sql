...
DROP TABLE IF EXISTS chi_tiet_danh_gia CASCADE;
DROP TABLE IF EXISTS thanh_vien_danh_gia CASCADE;
DROP TABLE IF EXISTS lich_danh_gia CASCADE;
...
DROP TRIGGER IF EXISTS update_lich_danh_gia_updated_at ON lich_danh_gia;
...
DROP POLICY IF EXISTS "Cho phép đọc tất cả lịch đánh giá" ON lich_danh_gia;
DROP POLICY IF EXISTS "Cho phép tạo lịch đánh giá" ON lich_danh_gia;
DROP POLICY IF EXISTS "Cho phép cập nhật lịch đánh giá" ON lich_danh_gia;
DROP POLICY IF EXISTS "Cho phép xóa lịch đánh giá" ON lich_danh_gia;
